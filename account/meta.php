...
<link href="<?php echo $website_url ?>/account/style/network-alert.css" type="text/css" rel="stylesheet" />
...
<script src="<?php echo $website_url ?>/account/js/bottom-scripts.js"></script>
